...
## חיסכון ב-tokens של הסוכן הראשי

אחרי כל שלב בפיפליין שהסתיים בהצלחה, הרץ:
/compact

זה מחליף את היסטוריית השיחה בסיכום קצר.
המידע החשוב נשמר, tokens מיותרים נחסכים.
...
## כללי חיסכון ב-tokens

- קרא tasks/lessons.md לפני כל משימה
- לפני כל תיקון, כתוב את אבחון הבעיה ב-tasks/todo.md
